...
import katalontoselenium.com.projects.katalon.com.pages.AIVisual.AIVisualPage;
import katalontoselenium.com.projects.katalon.com.pages.BusinessOutcomes.BusinessOutcomesPage;
import katalontoselenium.com.projects.katalon.com.pages.CaseStudies.CaseStudiesPage;
import katalontoselenium.com.projects.katalon.com.pages.Contact.ContactPage;
import katalontoselenium.com.projects.katalon.com.pages.KatalonPlatform.KatalonPlatformPage;
import katalontoselenium.com.projects.katalon.com.pages.KatalonStudio.KatalonStudioPage;
import katalontoselenium.com.projects.katalon.com.pages.Tasks.CommonPage;
import katalontoselenium.com.projects.katalon.com.pages.TestCloud.TestCloudPage;
import katalontoselenium.com.projects.katalon.com.pages.Testops.TestopsPage;
...
public class DashboardPage  extends CommonPage {
    ...
    public AIVisualPage openAIVisualPage() {
        WebUI.clickElement(dropdownPlatform);
        WebUI.clickElement(dropdownAIVisualTesting);
        return new AIVisualPage();
    }
    public BusinessOutcomesPage openBusinessOutcomesPage(){
        WebUI.clickElement(dropdownWhykatalon);
        WebUI.clickElement(dropdownBO);
        return new BusinessOutcomesPage();
    }
    public CaseStudiesPage openCaseStudiesPage(){
        WebUI.clickElement(dropdownWhykatalon);
        WebUI.clickElement(dropdownSS);
        return new CaseStudiesPage();
    }
    public ContactPage openContactPage(){
        WebUI.clickElement(buttonContactus);
        return new ContactPage();
    }
    public KatalonPlatformPage openKatalonPlatformPage(){
        WebUI.clickElement(dropdownPlatform);
        WebUI.clickElement(dropdownPO);
        return new KatalonPlatformPage();
    }
    public KatalonStudioPage openKatalonStudioPage(){
        WebUI.clickElement(dropdownPlatform);
        WebUI.clickElement(dropdownKS);
        return new KatalonStudioPage();
    }
    public TestCloudPage openTestCloudPage(){
        WebUI.clickElement(dropdownPlatform);
        WebUI.clickElement(dropdownKatalonTestCloud);
        return new TestCloudPage();
    }
    public TestopsPage openTestopsPage(){
        WebUI.clickElement(dropdownPlatform);
        WebUI.clickElement(dropdownKatalonTestOps);
        return new TestopsPage();
    }
